...
| `memoryConsolidation` | object | See [Memory System → Consolidation](../concepts/memory#memory-consolidation). |
| `factExtraction` | object | See [Memory System → Fact Extraction](../concepts/memory#fact-extraction). |
